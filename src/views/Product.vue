<template>
  <div>
    ...
    <div class="container pb-5">
      <div class="row">
        <div class="col-md-12">
          <div class="Product_wall mb-5">
            <div class="Product_wallTitle">
              <h2 class="">商品細節</h2>
            </div>
          </div>
        </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="user mt-5">
                    <img src="https://upload.cc/i1/2021/02/19/NhYUdK.png" class="user_img">
                    <div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="user mt-5">
                    <img src="https://upload.cc/i1/2021/02/19/kwm0Xd.png" class="user_img">
                    <div>
                      <div class="user_stars mb-2 text-warning">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="user mt-5">
                    <img src="https://upload.cc/i1/2021/02/19/9QABCf.png" class="user_img">
                    <div>
                      <div class="user_stars mb-2 text-warning">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
